...
User runs `/BELIEF synthesize` or asks to process session notes, analyze the BELIEF session, debrief, or synthesize what happened in the meeting.
...
- Update "Last Updated" field: `[today's date] by /BELIEF synthesize`
...
Note these as seeds for `/BELIEF distill`.
...
> "Would you like to:
> - Run `/BELIEF distill` to generate brand foundation drafts from this synthesis?
